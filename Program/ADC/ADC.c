...
void ADC1_CH_DMA_Config(void)
{
	...
	ADC_RegularChannelConfig(ADC1, ADC_Channel_17, 5, ADC_SampleTime_239Cycles5);//vref
	ADC_RegularChannelConfig(ADC1, ADC_Channel_16, 6, ADC_SampleTime_41Cycles5);//temp
	ADC_Cmd ( ADC1 , ENABLE ) ;
