...
uint8_t CalibrationWriteToFlash(void)
{
	...
	flash_write( CalibrationData.CalibrationValueForCurrent_x1_AddresInEEprom, CalibrationData.CalibrationValueForCurrent_x1);
	flash_write( CalibrationData.CalibrationValueForCurrent_x11_AddresInEEprom, CalibrationData.CalibrationValueForCurrent_x50);
...
uint8_t CalibrationFactoryWriteToFlash(void)
{
	...
	flash_write( CalibrationDataFactory.CalibrationValueForCurrent_x1_AddresInEEprom, CalibrationDataFactory.CalibrationValueForCurrent_x1);
	flash_write( CalibrationDataFactory.CalibrationValueForCurrent_x11_AddresInEEprom, CalibrationDataFactory.CalibrationValueForCurrent_x50);
...
uint8_t CalibrationReadFromFlash(void)
{
	...
	CalibrationData.CalibrationValueForCurrent_x1 = flash_read(CalibrationData.CalibrationValueForCurrent_x1_AddresInEEprom,10,100000);
	CalibrationData.CalibrationValueForCurrent_x50 = flash_read(CalibrationData.CalibrationValueForCurrent_x11_AddresInEEprom,10,100000);
...
uint8_t CalibrationReadFromFlashForVerify(void)
{
	...
	CalibrationDataForVerify.CalibrationValueForCurrent_x1 = flash_read(CalibrationDataForVerify.CalibrationValueForCurrent_x1_AddresInEEprom,10,100000);
	CalibrationDataForVerify.CalibrationValueForCurrent_x50 = flash_read(CalibrationDataForVerify.CalibrationValueForCurrent_x11_AddresInEEprom,10,100000);
